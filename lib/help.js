...
*Kyomi Bot*
- *${prefix}tempest (para entrar no meu grupo)*
_Novidades_ 
*${prefix}pau*
_Mede o tamanho do... ne_
*${prefix}top5 <tema do top5>*
_Lista um top5 alguma coisa_
*${prefix}comer <marque quem voce quer comer>*
_Marque alguem para comer_
*${prefix}abraçar <marque quem voce quer abraçar*
_Marque alguem para abraçar_
...
*146 - ${prefix}pau*
_Bem ele mede o tamanho do... Ne_

*147 - ${prefix}top5 <tema do top5>*
_Lista top5 alguma coisa_
